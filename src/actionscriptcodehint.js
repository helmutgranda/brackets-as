...
define(function (require, exports, module) {
    ...
    var AppInit = brackets.getModule('utils/AppInit'),
        actionscriptSyntax = require('text!src/actionscriptsyntax.txt');
    ...
    WordHints.prototype.hasHints = function (editor, implicitChar) {
        ...
        if(cursor.line != this.lastLine){
            var rawWordList = actionscriptSyntax.match(this.tokenDefinition);
            this.cachedWordList = [];
    ...
    AppInit.appReady(function () {
        ...
        ExtensionUtils.loadStyleSheet(module, 'brackets-as-hints.css');
    });
});
